...
CREATE TABLE `cms_activity`  (
  ...
  `desc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '摘要或描述',
  `thumb` int(11) NOT NULL DEFAULT 0 COMMENT '缩略图:附件id',
  `origin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '来源或作者',
  `origin_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '来源地址',
  `integral` int(11) NOT NULL DEFAULT 0 COMMENT '参加活动赠送积分',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '内容',
  `read` int(11) NOT NULL DEFAULT 0 COMMENT '阅读量',
  `type` tinyint(4) NOT NULL DEFAULT 0 COMMENT '属性:1精华,2热门,3推荐',
...
-- ----------------------------
INSERT INTO `cms_activity` VALUES (1, '测试活动', 4, '最新活动', 7, '', '', 500, '<p>最新活动最新活动最新活动最新活动最新活动最新活动</p>', 0, 0, 0, 1, 1, 0, 1669022897, 0, 0);

-- ----------------------------
-- Table structure for cms_activity_cate
-- ----------------------------
DROP TABLE IF EXISTS `cms_activity_cate`;
CREATE TABLE `cms_activity_cate`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章分类::crud' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_activity_cate
-- ----------------------------
INSERT INTO `cms_activity_cate` VALUES (4, 0, '最新活动', '活动', '最新活动', 0, 1669022002, 0, 0);
...
CREATE TABLE `cms_admin`  (
  ...
  `mobile` bigint(20) NULL DEFAULT 0,
  ...
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '1正常,0禁止登录,-1删除',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `cms_admin` VALUES (1, 'admin', 'ee0f859e570bdacb051fdbaec111e6d1', 'mJCzoq6ruj8vwRSPUgtV', '超级管理员', '/static/admin/images/icon.png', 'black', 0, '', NULL, 1, 1, 1668932070, 1668932070, 1668995609, 2, '127.0.0.1', 1);
...
CREATE TABLE `cms_admin_log`  (
  ...
  `param_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '操作数据id',
  ...
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台操作日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_admin_log
-- ----------------------------
INSERT INTO `cms_admin_log` VALUES (1, 1, '超级管理员', 'login', '登录', '系统', '', '超级管理员在2022-11-20 16:14:44登录了系统', 'admin', 'login', 'login_submit', '', '127.0.0.1', 1, '{\"last_login_time\":1668932084,\"last_login_ip\":\"127.0.0.1\",\"login_num\":1}', 1, 1668932084);
INSERT INTO `cms_admin_log` VALUES (2, 1, '超级管理员', 'edit', '编辑', '配置详情', '编辑', '超级管理员在2022-11-20 16:25:07编辑了配置详情', 'admin', 'conf', 'edit', '', '127.0.0.1', 1, '{\"id\":\"1\",\"admin_title\":\"\\u4e00\\u4f17\\u517b\\u8001\",\"title\":\"\\u4e00\\u4f17\\u517b\\u8001\",\"logo\":\"\\/static\\/admin\\/images\\/nonepic360x360.jpg\",\"file\":\"\",\"domain\":\"https:\\/\\/www.gougucms.com\",\"icp\":\"\\u7ca4ICP\\u59071xxxxxx11\\u53f7-1\",\"keywords\":\"\\u4e00\\u4f17\\u517b\\u8001\",\"beian\":\"\\u7ca4\\u516c\\u7f51\\u5b89\\u59071xxxxxx11\\u53f7-1\",\"desc\":\"\\u4e00\\u4f17\\u517b\\u8001\",\"code\":\"\",\"copyright\":\"\\u00a9 2022 gougucms.com Apache-2.0 license\",\"version\":\"2.0.18\"}', 1, 1668932707);
INSERT INTO `cms_admin_log` VALUES (3, 1, '超级管理员', 'edit', '编辑', '功能节点', '新建/编辑', '超级管理员在2022-11-20 16:34:05编辑了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 23, '{\"pid\":\"1\",\"menu\":\"2\",\"title\":\"\\u90e8\\u95e8\\u67b6\\u6784\",\"name\":\"\\u90e8\\u95e8\",\"src\":\"admin\\/department\\/index\",\"sort\":\"1\",\"icon\":\"\",\"id\":\"23\"}', 1, 1668933245);
INSERT INTO `cms_admin_log` VALUES (4, 1, '超级管理员', 'edit', '编辑', '功能节点', '新建/编辑', '超级管理员在2022-11-20 16:34:28编辑了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 26, '{\"pid\":\"1\",\"menu\":\"2\",\"title\":\"\\u5c97\\u4f4d\\u804c\\u79f0\",\"name\":\"\\u5c97\\u4f4d\\u804c\\u79f0\",\"src\":\"admin\\/position\\/index\",\"sort\":\"1\",\"icon\":\"\",\"id\":\"26\"}', 1, 1668933268);
INSERT INTO `cms_admin_log` VALUES (5, 1, '超级管理员', 'edit', '编辑', '用户等级', '新建/编辑', '超级管理员在2022-11-20 16:36:13编辑了用户等级', 'admin', 'level', 'add', '', '127.0.0.1', 1, '{\"id\":\"1\",\"title\":\"\\u5fd7\\u613f\\u8005\",\"desc\":\"\",\"update_time\":1668933373}', 1, 1668933373);
INSERT INTO `cms_admin_log` VALUES (6, 1, '超级管理员', 'edit', '编辑', '用户等级', '新建/编辑', '超级管理员在2022-11-20 16:36:24编辑了用户等级', 'admin', 'level', 'add', '', '127.0.0.1', 2, '{\"id\":\"2\",\"title\":\"\\u7ad9\\u957f\",\"desc\":\"\",\"update_time\":1668933384}', 1, 1668933384);
INSERT INTO `cms_admin_log` VALUES (7, 1, '超级管理员', 'disable', '禁用', '用户等级', '禁用/启用', '超级管理员在2022-11-20 16:36:29禁用了用户等级', 'admin', 'level', 'disable', '', '127.0.0.1', 6, '{\"id\":\"6\",\"status\":\"0\",\"update_time\":1668933389}', 1, 1668933389);
INSERT INTO `cms_admin_log` VALUES (8, 1, '超级管理员', 'disable', '禁用', '用户等级', '禁用/启用', '超级管理员在2022-11-20 16:36:35禁用了用户等级', 'admin', 'level', 'disable', '', '127.0.0.1', 5, '{\"id\":\"5\",\"status\":\"0\",\"update_time\":1668933395}', 1, 1668933395);
INSERT INTO `cms_admin_log` VALUES (9, 1, '超级管理员', 'disable', '禁用', '用户等级', '禁用/启用', '超级管理员在2022-11-20 16:36:38禁用了用户等级', 'admin', 'level', 'disable', '', '127.0.0.1', 4, '{\"id\":\"4\",\"status\":\"0\",\"update_time\":1668933398}', 1, 1668933398);
INSERT INTO `cms_admin_log` VALUES (10, 1, '超级管理员', 'disable', '禁用', '用户等级', '禁用/启用', '超级管理员在2022-11-20 16:36:40禁用了用户等级', 'admin', 'level', 'disable', '', '127.0.0.1', 3, '{\"id\":\"3\",\"status\":\"0\",\"update_time\":1668933400}', 1, 1668933400);
INSERT INTO `cms_admin_log` VALUES (11, 1, '超级管理员', 'delete', '删除', '单页面', '删除', '超级管理员在2022-11-20 17:19:59删除了单页面', 'admin', 'pages', 'del', '', '127.0.0.1', 3, '[]', 1, 1668935999);
INSERT INTO `cms_admin_log` VALUES (12, 1, '超级管理员', 'delete', '删除', '单页面', '删除', '超级管理员在2022-11-20 17:20:03删除了单页面', 'admin', 'pages', 'del', '', '127.0.0.1', 2, '[]', 1, 1668936003);
INSERT INTO `cms_admin_log` VALUES (13, 1, '超级管理员', 'delete', '删除', '文章', '删除', '超级管理员在2022-11-20 17:21:20删除了文章', 'admin', 'article', 'del', '', '127.0.0.1', 4, '[]', 1, 1668936080);
INSERT INTO `cms_admin_log` VALUES (14, 1, '超级管理员', 'delete', '删除', '文章', '删除', '超级管理员在2022-11-20 17:21:22删除了文章', 'admin', 'article', 'del', '', '127.0.0.1', 3, '[]', 1, 1668936082);
INSERT INTO `cms_admin_log` VALUES (15, 1, '超级管理员', 'delete', '删除', '文章', '删除', '超级管理员在2022-11-20 17:21:24删除了文章', 'admin', 'article', 'del', '', '127.0.0.1', 2, '[]', 1, 1668936084);
INSERT INTO `cms_admin_log` VALUES (16, 1, '超级管理员', 'delete', '删除', '文章', '删除', '超级管理员在2022-11-20 17:21:26删除了文章', 'admin', 'article', 'del', '', '127.0.0.1', 1, '[]', 1, 1668936086);
INSERT INTO `cms_admin_log` VALUES (17, 1, '超级管理员', 'delete', '删除', '文章分类', '删除', '超级管理员在2022-11-20 17:21:36删除了文章分类', 'admin', 'article_cate', 'del', '', '127.0.0.1', 1, '[]', 1, 1668936096);
INSERT INTO `cms_admin_log` VALUES (18, 1, '超级管理员', 'add', '新增', '文章分类', '新建', '超级管理员在2022-11-20 17:22:04新增了文章分类', 'admin', 'article_cate', 'add', '', '127.0.0.1', 2, '{\"pid\":\"0\",\"sort\":\"0\",\"title\":\"\\u5065\\u5eb7\\u70ed\\u70b9\",\"keywords\":\"\\u5065\\u5eb7\\u70ed\\u70b9\",\"desc\":\"\\u5065\\u5eb7\\u70ed\\u70b9\",\"id\":\"0\",\"create_time\":1668936124}', 1, 1668936124);
INSERT INTO `cms_admin_log` VALUES (19, 1, '超级管理员', 'add', '新增', '文章分类', '新建', '超级管理员在2022-11-20 17:22:39新增了文章分类', 'admin', 'article_cate', 'add', '', '127.0.0.1', 3, '{\"pid\":\"0\",\"sort\":\"0\",\"title\":\"\\u653f\\u7b56\\u65b0\\u95fb\",\"keywords\":\"\\u653f\\u7b56\\u65b0\\u95fb\",\"desc\":\"\\u653f\\u7b56\\u65b0\\u95fb\",\"id\":\"0\",\"create_time\":1668936159}', 1, 1668936159);
INSERT INTO `cms_admin_log` VALUES (20, 1, '超级管理员', 'upload', '上传', '系统', '', '超级管理员在2022-11-20 17:25:05上传了系统', 'admin', 'api', 'upload', '', '127.0.0.1', 1, '{\"filepath\":\"\\/storage\\/202211\\/8d97e61a3be94d79027c6d9da3dce27a.png\",\"name\":\"\\u9910\\u5177,\\u5200\\u53c9,\\u5916\\u5356,\\u7f8e\\u98df@3x.png\",\"mimetype\":\"image\\/png\",\"fileext\":\"png\",\"filesize\":51785,\"filename\":\"202211\\/8d97e61a3be94d79027c6d9da3dce27a.png\",\"sha1\":\"cfd42087a4a92d018de57a4865b14e60a2ad5b5c\",\"md5\":\"8d97e61a3be94d79027c6d9da3dce27a\",\"module\":\"admin\",\"action\":\"upload\",\"uploadip\":\"127.0.0.1\",\"create_time\":1668936305,\"user_id\":1,\"status\":1,\"admin_id\":1,\"audit_time\":1668936305,\"use\":\"thumb\"}', 1, 1668936305);
INSERT INTO `cms_admin_log` VALUES (21, 1, '超级管理员', 'add', '新增', '文章', '新建', '超级管理员在2022-11-20 17:25:07新增了文章', 'admin', 'article', 'add', '', '127.0.0.1', 5, '{\"title\":\"\\u70ed\\u70b9\",\"cate_id\":\"2\",\"keyword_names\":\"\\u5065\\u5eb7\\u70ed\\u70b9\",\"keyword_ids\":\"0\",\"status\":\"1\",\"sort\":\"0\",\"is_home\":\"1\",\"type\":\"1\",\"original\":\"1\",\"origin\":\"\",\"origin_url\":\"\",\"desc\":\"\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\",\"file\":\"\",\"thumb\":\"5\",\"content\":\"<p>\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9\\u70ed\\u70b9<\\/p>\",\"md_content\":\"\",\"admin_id\":1,\"create_time\":1668936307}', 1, 1668936307);
INSERT INTO `cms_admin_log` VALUES (22, 1, '超级管理员', 'upload', '上传', '系统', '', '超级管理员在2022-11-20 17:25:45上传了系统', 'admin', 'api', 'upload', '', '127.0.0.1', 1, '{\"filepath\":\"\\/storage\\/202211\\/de39e4ea7f4f311ade8bd0b92ee83420.png\",\"name\":\"\\u9910\\u5177,\\u5200\\u53c9,\\u5916\\u5356,\\u7f8e\\u98df.png\",\"mimetype\":\"image\\/png\",\"fileext\":\"png\",\"filesize\":8921,\"filename\":\"202211\\/de39e4ea7f4f311ade8bd0b92ee83420.png\",\"sha1\":\"65c03309a340259b2ac817a0836b064637258748\",\"md5\":\"de39e4ea7f4f311ade8bd0b92ee83420\",\"module\":\"admin\",\"action\":\"upload\",\"uploadip\":\"127.0.0.1\",\"create_time\":1668936345,\"user_id\":1,\"status\":1,\"admin_id\":1,\"audit_time\":1668936345,\"use\":\"thumb\"}', 1, 1668936345);
INSERT INTO `cms_admin_log` VALUES (23, 1, '超级管理员', 'add', '新增', '文章', '新建', '超级管理员在2022-11-20 17:25:49新增了文章', 'admin', 'article', 'add', '', '127.0.0.1', 6, '{\"title\":\"\\u653f\\u7b56\\u653f\\u7b56\",\"cate_id\":\"3\",\"keyword_names\":\"\\u653f\\u7b56\",\"keyword_ids\":\"0\",\"status\":\"1\",\"sort\":\"0\",\"is_home\":\"1\",\"type\":\"1\",\"original\":\"1\",\"origin\":\"\",\"origin_url\":\"\",\"desc\":\"\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\",\"file\":\"\",\"thumb\":\"6\",\"content\":\"<p>\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56\\u653f\\u7b56<\\/p>\",\"md_content\":\"\",\"admin_id\":1,\"create_time\":1668936349}', 1, 1668936349);
INSERT INTO `cms_admin_log` VALUES (24, 1, '超级管理员', 'login', '登录', '系统', '', '超级管理员在2022-11-21 09:53:29登录了系统', 'admin', 'login', 'login_submit', '', '127.0.0.1', 1, '{\"last_login_time\":1668995609,\"last_login_ip\":\"127.0.0.1\",\"login_num\":2}', 1, 1668995609);
INSERT INTO `cms_admin_log` VALUES (25, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 14:55:30新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 113, '{\"pid\":\"0\",\"menu\":\"1\",\"title\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"\",\"sort\":\"5\",\"icon\":\"bi-newspaper\",\"id\":\"0\",\"create_time\":1669013730}', 1, 1669013730);
INSERT INTO `cms_admin_log` VALUES (26, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 14:56:41新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 114, '{\"pid\":\"113\",\"menu\":\"1\",\"title\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"admin\\/activity\\/datalist\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669013801}', 1, 1669013801);
INSERT INTO `cms_admin_log` VALUES (27, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 14:57:18新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 115, '{\"pid\":\"113\",\"menu\":\"1\",\"title\":\"\\u6d3b\\u52a8\\u5206\\u7c7b\",\"name\":\"\\u6d3b\\u52a8\\u5206\\u7c7b \",\"src\":\"admin\\/activity_cate\\/datalist\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669013838}', 1, 1669013838);
INSERT INTO `cms_admin_log` VALUES (28, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:12:05新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 116, '{\"pid\":\"115\",\"menu\":\"2\",\"title\":\"\\u65b0\\u5efa\",\"name\":\"\\u65b0\\u5efa\",\"src\":\"admin\\/activity_cate\\/add\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669014725}', 1, 1669014725);
INSERT INTO `cms_admin_log` VALUES (29, 1, '超级管理员', 'edit', '编辑', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:12:47编辑了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 116, '{\"pid\":\"115\",\"menu\":\"2\",\"title\":\"\\u65b0\\u5efa\",\"name\":\"\\u6d3b\\u52a8\\u5206\\u7c7b\",\"src\":\"admin\\/activity_cate\\/add\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"116\"}', 1, 1669014767);
INSERT INTO `cms_admin_log` VALUES (30, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:14:20新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 117, '{\"pid\":\"115\",\"menu\":\"2\",\"title\":\"\\u7f16\\u8f91\",\"name\":\"\\u6d3b\\u52a8\\u5206\\u7c7b\",\"src\":\"admin\\/activity_cate\\/edit\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669014860}', 1, 1669014860);
INSERT INTO `cms_admin_log` VALUES (31, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:15:04新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 118, '{\"pid\":\"115\",\"menu\":\"2\",\"title\":\"\\u5220\\u9664\",\"name\":\"\\u6d3b\\u52a8\\u5206\\u7c7b\",\"src\":\"admin\\/activity_cate\\/del\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669014904}', 1, 1669014904);
INSERT INTO `cms_admin_log` VALUES (32, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:18:22新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 119, '{\"pid\":\"114\",\"menu\":\"2\",\"title\":\"\\u65b0\\u5efa\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"admin\\/activity\\/add\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669015102}', 1, 1669015102);
INSERT INTO `cms_admin_log` VALUES (33, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:19:03新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 120, '{\"pid\":\"114\",\"menu\":\"2\",\"title\":\"\\u7f16\\u8f91\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"admin\\/activity\\/edit\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669015143}', 1, 1669015143);
INSERT INTO `cms_admin_log` VALUES (34, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:19:42新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 121, '{\"pid\":\"114\",\"menu\":\"2\",\"title\":\"\\u5220\\u9664\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"admin\\/activity\\/del\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669015182}', 1, 1669015182);
INSERT INTO `cms_admin_log` VALUES (35, 1, '超级管理员', 'add', '新增', '功能节点', '新建/编辑', '超级管理员在2022-11-21 15:20:31新增了功能节点', 'admin', 'rule', 'add', '', '127.0.0.1', 122, '{\"pid\":\"114\",\"menu\":\"2\",\"title\":\"\\u67e5\\u770b\",\"name\":\"\\u6d3b\\u52a8\\u5217\\u8868\",\"src\":\"admin\\/activity\\/read\",\"sort\":\"0\",\"icon\":\"\",\"id\":\"0\",\"create_time\":1669015231}', 1, 1669015231);
INSERT INTO `cms_admin_log` VALUES (36, 1, '超级管理员', 'edit', '编辑', '配置详情', '编辑', '超级管理员在2022-11-21 15:36:05编辑了配置详情', 'admin', 'conf', 'edit', '', '127.0.0.1', 5, '{\"id\":\"5\",\"author\":\"\\u52fe\\u80a1\\u5de5\\u4f5c\\u5ba4\",\"version\":\"v2.0.16\",\"editor\":\"2\"}', 1, 1669016165);
INSERT INTO `cms_admin_log` VALUES (37, 1, '超级管理员', 'add', '新增', '活动分类', '新建', '超级管理员在2022-11-21 17:13:22新增了活动分类', 'admin', 'activity_cate', 'add', '', '127.0.0.1', 4, '{\"pid\":\"0\",\"sort\":\"0\",\"title\":\"\\u6700\\u65b0\\u6d3b\\u52a8\",\"keywords\":\"\\u6d3b\\u52a8\",\"desc\":\"\\u6700\\u65b0\\u6d3b\\u52a8\",\"id\":\"0\",\"create_time\":1669022002}', 1, 1669022002);
INSERT INTO `cms_admin_log` VALUES (38, 1, '超级管理员', 'edit', '编辑', '配置详情', '编辑', '超级管理员在2022-11-21 17:23:27编辑了配置详情', 'admin', 'conf', 'edit', '', '127.0.0.1', 5, '{\"id\":\"5\",\"author\":\"\\u52fe\\u80a1\\u5de5\\u4f5c\\u5ba4\",\"version\":\"v2.0.16\",\"editor\":\"1\"}', 1, 1669022607);
INSERT INTO `cms_admin_log` VALUES (39, 1, '超级管理员', 'upload', '上传', '系统', '', '超级管理员在2022-11-21 17:28:15上传了系统', 'admin', 'api', 'upload', '', '127.0.0.1', 1, '{\"filepath\":\"\\/storage\\/202211\\/9a39b8fc35bce0750aa45015bdcababc.png\",\"name\":\"xinpin.png\",\"mimetype\":\"image\\/png\",\"fileext\":\"png\",\"filesize\":4081,\"filename\":\"202211\\/9a39b8fc35bce0750aa45015bdcababc.png\",\"sha1\":\"2898ec6bcebd9867c9611c06b4ff7daa83e4224d\",\"md5\":\"9a39b8fc35bce0750aa45015bdcababc\",\"module\":\"admin\",\"action\":\"upload\",\"uploadip\":\"127.0.0.1\",\"create_time\":1669022895,\"user_id\":1,\"status\":1,\"admin_id\":1,\"audit_time\":1669022895,\"use\":\"thumb\"}', 1, 1669022895);
INSERT INTO `cms_admin_log` VALUES (40, 1, '超级管理员', 'add', '新增', '活动列表', '新建', '超级管理员在2022-11-21 17:28:17新增了活动列表', 'admin', 'activity', 'add', '', '127.0.0.1', 1, '{\"title\":\"\\u6d4b\\u8bd5\\u6d3b\\u52a8\",\"cate_id\":\"4\",\"status\":\"1\",\"type\":\"\",\"sort\":\"0\",\"integral\":\"500\",\"origin\":\"\",\"origin_url\":\"\",\"desc\":\"\\u6700\\u65b0\\u6d3b\\u52a8\",\"file\":\"\",\"thumb\":\"7\",\"content\":\"<p>\\u6700\\u65b0\\u6d3b\\u52a8\\u6700\\u65b0\\u6d3b\\u52a8\\u6700\\u65b0\\u6d3b\\u52a8\\u6700\\u65b0\\u6d3b\\u52a8\\u6700\\u65b0\\u6d3b\\u52a8\\u6700\\u65b0\\u6d3b\\u52a8<\\/p>\",\"md_content\":\"\",\"admin_id\":1,\"create_time\":1669022897}', 1, 1669022897);
...
CREATE TABLE `cms_admin_module`  (
  ...
  `type` int(11) NOT NULL DEFAULT 2 COMMENT '模块类型,2普通模块,1系统模块',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cms_admin_rule`  (
  ...
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图标',
  `menu` int(11) NOT NULL DEFAULT 0 COMMENT '是否是菜单,1是,2不是',
  ...
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单及权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cms_admin_rule` VALUES (23, 1, 'admin/department/index', '部门架构', '部门', '', 2, 1, 1, '', '', 0, 0);
...
INSERT INTO `cms_admin_rule` VALUES (26, 1, 'admin/position/index', '岗位职称', '岗位职称', '', 2, 1, 1, '', '', 0, 0);
...
INSERT INTO `cms_admin_rule` VALUES (113, 0, '', '活动列表', '活动列表', 'bi-newspaper', 1, 5, 1, '', '', 1669013730, 0);
INSERT INTO `cms_admin_rule` VALUES (114, 113, 'admin/activity/datalist', '活动列表', '活动列表', '', 1, 0, 1, '', '', 1669013801, 0);
INSERT INTO `cms_admin_rule` VALUES (115, 113, 'admin/activity_cate/datalist', '活动分类', '活动分类 ', '', 1, 0, 1, '', '', 1669013838, 0);
INSERT INTO `cms_admin_rule` VALUES (116, 115, 'admin/activity_cate/add', '新建', '活动分类', '', 2, 0, 1, '', '', 1669014725, 0);
INSERT INTO `cms_admin_rule` VALUES (117, 115, 'admin/activity_cate/edit', '编辑', '活动分类', '', 2, 0, 1, '', '', 1669014860, 0);
INSERT INTO `cms_admin_rule` VALUES (118, 115, 'admin/activity_cate/del', '删除', '活动分类', '', 2, 0, 1, '', '', 1669014904, 0);
INSERT INTO `cms_admin_rule` VALUES (119, 114, 'admin/activity/add', '新建', '活动列表', '', 2, 0, 1, '', '', 1669015102, 0);
INSERT INTO `cms_admin_rule` VALUES (120, 114, 'admin/activity/edit', '编辑', '活动列表', '', 2, 0, 1, '', '', 1669015143, 0);
INSERT INTO `cms_admin_rule` VALUES (121, 114, 'admin/activity/del', '删除', '活动列表', '', 2, 0, 1, '', '', 1669015182, 0);
INSERT INTO `cms_admin_rule` VALUES (122, 114, 'admin/activity/read', '查看', '活动列表', '', 2, 0, 1, '', '', 1669015231, 0);
...
CREATE TABLE `cms_article`  (
  ...
  `thumb` int(11) NOT NULL DEFAULT 0 COMMENT '缩略图:附件id',
  `original` int(11) NOT NULL DEFAULT 0 COMMENT '是否原创:1是,0否',
  ...
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT '排序',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '状态:1正常,0下架',
  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建人',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `delete_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章::crud' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_article
-- ----------------------------
INSERT INTO `cms_article` VALUES (1, 1, '勾股CMS——轻量级、高性能极速后台开发框架', '勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。', 1, 0, '', '', '<p>勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。</p>\n<p><img src=\"https://blog.gougucms.com/storage/image/202109/1630457997502502.png\" /></p>', '勾股CMS是一套基于ThinkPHP6 + Layui + MySql打造的轻量级、高性能极速后台开发框架。通用型的后台权限管理框架，极低门槛、操作简单、开箱即用。系统易于功能扩展，代码维护，方便二次开发，让开发者更专注于业务深度需求的开发，帮助开发者简单高效降低二次开发成本。', 0, 2, 1, 0, 1, 1, 1625071256, 1650811576, 1668936086);
INSERT INTO `cms_article` VALUES (2, 1, '勾股BLOG——简约，易用开源的个人博客系统', '勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自...', 2, 0, '', '', '<p>勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自媒体官网等网站，二次开发之后也可以作为资讯、展品展示等网站。</p>\n<p><img src=\"https://blog.gougucms.com/storage/image/b1.png\" /></p>', '勾股BLOG是一款实用的开源免费的个人博客系统。集成了系统管理、基础数据、博客文章、博客动态、语雀知识库、用户管理、访问统计等功能。具有简约，易用，内存占用低等特点，可以用来做个人博客，工作室官网，自媒体官网等网站，二次开发之后也可以作为资讯、展品展示等网站。', 0, 0, 1, 0, 1, 1, 1650811439, 1650811624, 1668936084);
INSERT INTO `cms_article` VALUES (3, 1, '勾股OA——实用的开源的企业办公系统框架', '勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，...', 3, 0, '', '', '<p>勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。</p>\n<p><img src=\"https://oa.gougucms.com/storage/image/oa1.png\" /></p>', '勾股OA是一款实用的开源免费的企业办公系统框架。它集成了系统设置、人事管理、消息管理、审批管理、日常办公、财务管理等基础模块。系统简约，易于功能扩展，方便二次开发，让开发者更专注于业务深度需求的开发，通过二次开发之后可以用来做CRM，ERP，业务管理等系统。', 0, 0, 1, 0, 1, 1, 1650811502, 1650811709, 1668936082);
INSERT INTO `cms_article` VALUES (4, 1, '勾股DEV——研发管理与团队协作的工具软件', '勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。', 4, 0, '', '', '<p>勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。</p>\n<p><img src=\"https://dev.gougucms.com/storage/202204/dev2.png\" /></p>', '勾股DEV是一款专为IT行业研发团队打造的智能化项目管理与团队协作的工具软件，可以在线管理团队的工作、项目和任务，覆盖从需求提出到研发完成上线整个过程的项目协作。', 0, 0, 1, 0, 1, 1, 1650811542, 1650811682, 1668936080);
INSERT INTO `cms_article` VALUES (5, 2, '热点', '热点热点热点', 5, 1, '', '', '<p>热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点热点</p>', '', 0, 1, 1, 0, 1, 1, 1668936307, 0, 0);
INSERT INTO `cms_article` VALUES (6, 3, '政策政策', '政策政策政策政策政策政策', 6, 1, '', '', '<p>政策政策政策政策政策政策政策政策政策政策政策政策政策政策政策政策</p>', '', 0, 1, 1, 0, 1, 1, 1668936349, 0, 0);
...
CREATE TABLE `cms_article_cate`  (
  ...
  `delete_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章分类::crud' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_article_cate
-- ----------------------------
INSERT INTO `cms_article_cate` VALUES (1, 0, '勾股开源系统', '勾股开源', '左手自研，右手开源', 0, 1610196442, 0, 1668936096);
INSERT INTO `cms_article_cate` VALUES (2, 0, '健康热点', '健康热点', '健康热点', 0, 1668936124, 0, 0);
INSERT INTO `cms_article_cate` VALUES (3, 0, '政策新闻', '政策新闻', '政策新闻', 0, 1668936159, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章关联表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cms_article_keywords` VALUES (5, 5, 5, 1, 1668936307);
INSERT INTO `cms_article_keywords` VALUES (6, 6, 6, 1, 1668936349);
...
-- ----------------------------
INSERT INTO `cms_config` VALUES (1, '网站配置', 'web', 'a:13:{s:2:\"id\";s:1:\"1\";s:11:\"admin_title\";s:12:\"一众养老\";s:5:\"title\";s:12:\"一众养老\";s:4:\"logo\";s:39:\"/static/admin/images/nonepic360x360.jpg\";s:4:\"file\";s:0:\"\";s:6:\"domain\";s:24:\"https://www.gougucms.com\";s:3:\"icp\";s:23:\"粤ICP备1xxxxxx11号-1\";s:8:\"keywords\";s:12:\"一众养老\";s:5:\"beian\";s:29:\"粤公网安备1xxxxxx11号-1\";s:4:\"desc\";s:12:\"一众养老\";s:4:\"code\";s:0:\"\";s:9:\"copyright\";s:39:\"© 2022 gougucms.com Apache-2.0 license\";s:7:\"version\";s:6:\"2.0.18\";}', 1, 1612514630, 1668932707);
...
INSERT INTO `cms_config` VALUES (5, '其他配置', 'other', 'a:4:{s:2:\"id\";s:1:\"5\";s:6:\"author\";s:15:\"勾股工作室\";s:7:\"version\";s:7:\"v2.0.16\";s:6:\"editor\";s:1:\"1\";}', 1, 1613725791, 1669022607);
...
CREATE TABLE `cms_department`  (
  ...
  `leader_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '部门负责人ID',
...
CREATE TABLE `cms_file`  (
  ...
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '上传会员ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cms_file` VALUES (5, 'admin', 'cfd42087a4a92d018de57a4865b14e60a2ad5b5c', '8d97e61a3be94d79027c6d9da3dce27a', '餐具,刀叉,外卖,美食@3x.png', '202211/8d97e61a3be94d79027c6d9da3dce27a.png', '/storage/202211/8d97e61a3be94d79027c6d9da3dce27a.png', 51785, 'png', 'image/png', 1, '127.0.0.1', 1, 1668936305, 1, 1668936305, 'upload', 'thumb', 0);
INSERT INTO `cms_file` VALUES (6, 'admin', '65c03309a340259b2ac817a0836b064637258748', 'de39e4ea7f4f311ade8bd0b92ee83420', '餐具,刀叉,外卖,美食.png', '202211/de39e4ea7f4f311ade8bd0b92ee83420.png', '/storage/202211/de39e4ea7f4f311ade8bd0b92ee83420.png', 8921, 'png', 'image/png', 1, '127.0.0.1', 1, 1668936345, 1, 1668936345, 'upload', 'thumb', 0);
INSERT INTO `cms_file` VALUES (7, 'admin', '2898ec6bcebd9867c9611c06b4ff7daa83e4224d', '9a39b8fc35bce0750aa45015bdcababc', 'xinpin.png', '202211/9a39b8fc35bce0750aa45015bdcababc.png', '/storage/202211/9a39b8fc35bce0750aa45015bdcababc.png', 4081, 'png', 'image/png', 1, '127.0.0.1', 1, 1669022895, 1, 1669022895, 'upload', 'thumb', 0);
...
CREATE TABLE `cms_gallery`  (
  ...
  `type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '属性:1精华,2热门,3推荐',
  `is_home` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否首页显示:0否,1是',
...
CREATE TABLE `cms_gallery_file`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '图集ID',
...
CREATE TABLE `cms_goods`  (
  ...
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `base_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '市场价格',
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '实际价格',
  ...
  `sort` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序',
  `is_mail` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '是否包邮:0否,1是',
...
CREATE TABLE `cms_goods_keywords`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品ID',
  `keywords_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联关键字id',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态:-1删除 0禁用 1启用',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cms_keywords`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关键字表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cms_keywords` VALUES (5, '健康热点', 0, 1, 1668936307, 0);
INSERT INTO `cms_keywords` VALUES (6, '政策', 0, 1, 1668936349, 0);
...
CREATE TABLE `cms_links`  (
  ...
  `target` int(11) NOT NULL DEFAULT 1 COMMENT '是否新窗口打开，1是,0否',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '状态:1可用-1禁用',
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT '排序',
  `create_time` int(11) NOT NULL DEFAULT 0,
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cms_nav`  (
  ...
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '1可用-1禁用',
...
CREATE TABLE `cms_nav_info`  (
  ...
  `target` int(11) NOT NULL DEFAULT 0 COMMENT '是否新窗口打开,默认0,1新窗口打开',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '1可用,-1禁用',
...
CREATE TABLE `cms_pages_keywords`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '页面ID',
  `keywords_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联关键字id',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：-1删除 0禁用 1启用',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cms_position`  (
  ...
  `work_price` int(11) NOT NULL DEFAULT 0 COMMENT '工时单价',
  `remark` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：-1删除 0禁用 1启用',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
...
CREATE TABLE `cms_sitemap`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网站地图内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cms_sitemap_cate`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网站地图分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cms_slide_info`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `slide_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '幻灯片详情表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `cms_user_level` VALUES (1, '游客', NULL, 1, 1639562910, 1668933384);
INSERT INTO `cms_user_level` VALUES (2, '志愿者', '', 1, 1639562910, 1668933373);
INSERT INTO `cms_user_level` VALUES (3, '站长', '', 1, 1639562910, 1668933384);
...
CREATE TABLE `cms_user_log`  (
  ...
  `function` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '方法',
  `ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '登录ip',
  `param_id` int(10) UNSIGNED NOT NULL COMMENT '操作ID',
  `param` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '参数json格式',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '0删除 1正常',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `cms_user_log` VALUES (1, 0, '游客', 'view', '查看', '游客在2022-11-20 16:18:03查看了首页', 'home', 'index', 'index', '127.0.0.1', 0, '[]', 1, 1668932283);
