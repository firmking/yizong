<?php /*a:2:{s:46:"G:\gougu\app\admin\view\article_cate\edit.html";i:1668565607;s:40:"G:\gougu\app\admin\view\common\base.html";i:1668565607;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form p-4">
	...
	<table class="layui-table layui-table-form">
		<tr>
			...
			<td>
				<input type="text" name="sort" placeholder="请输入排序，数字" autocomplete="off" class="layui-input" value="<?php echo htmlentities($detail['sort']); ?>">
			</td>
		</tr>
		<tr>
			<td class="layui-td-gray">分类名称<font>*</font></td>
			<td>
				<input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="请输入分类名称" class="layui-input" value="<?php echo htmlentities($detail['title']); ?>">
			</td>
			<td class="layui-td-gray">关键词</td>
			<td>
				<input type="text" name="keywords" placeholder="请输入关键词，用“,”隔开，可空" autocomplete="off" class="layui-input" value="<?php echo htmlentities($detail['keywords']); ?>">
			</td>
		</tr>
		<tr>
			<td class="layui-td-gray">描述</td>
			<td colspan="3">
				<textarea name="desc" placeholder="请输入描述，可空" class="layui-textarea"><?php echo htmlentities($detail['desc']); ?></textarea>
			</td>
		</tr>
	</table>
	<div class="py-3">
