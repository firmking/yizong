...
-- ----------------------------
INSERT INTO `cms_admin` VALUES (1, 'admin', 'ee0f859e570bdacb051fdbaec111e6d1', 'mJCzoq6ruj8vwRSPUgtV', '超级管理员', '/static/admin/images/icon.png', 'black', 0, '', NULL, 1, 1, 1668932070, 1668932070, 1668932084, 1, '127.0.0.1', 1);
...
CREATE TABLE `cms_admin_group_access`  (
  `uid` int(0) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `cms_article`  (
  ...
  `status` int(0) NOT NULL DEFAULT 1 COMMENT '状态:1正常,0下架',
...
CREATE TABLE `cms_article_keywords`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '文章ID',
  `keywords_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联关键字id',
...
CREATE TABLE `cms_gallery`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `cate_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '分类ID',
...
CREATE TABLE `cms_goods_keywords`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品ID',
  `keywords_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联关键字id',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态:-1删除 0禁用 1启用',
  `create_time` int(0) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cms_pages_keywords`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `aid` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '页面ID',
  `keywords_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '关联关键字id',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：-1删除 0禁用 1启用',
  `create_time` int(0) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
